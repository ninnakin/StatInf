...
hist(mu_simulations, breaks=20, prob=TRUE, 
     col="steelblue", border = "light blue",  
     main="Histogram over the simulated means compared to normal distribution", 
     xlab="Simulated mean")

points(x, hx, type="l", lwd=3, col="dark blue",
